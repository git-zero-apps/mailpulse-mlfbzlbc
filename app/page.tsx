    ...
    <div className="bg-[#0a0a0f] text-gray-100 min-h-screen relative">
      ...
      <section className="relative mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        ...
        <p className="animate-fade-up [animation-delay:350ms] mt-6 text-lg text-gray-400 sm:text-xl max-w-2xl mx-auto leading-relaxed">
          Simple email newsletters for creators and small businesses
        </p>
      ...
      <section id="features" className="bg-[#0a0a0f] py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">campaign-scheduling</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your campaign-scheduling with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your email-analytics with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your sendgrid-integration with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">bulk-subscriber-import</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your bulk-subscriber-import with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">webhook-event-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your webhook-event-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">campaign-performance-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your campaign-performance-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">bounce-handling</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your bounce-handling with ease using our intuitive interface.</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">
            Join thousands of teams who use MailPulse to work smarter.
          </p>
          <div className="mt-10">
            <Link
              href="/login"
