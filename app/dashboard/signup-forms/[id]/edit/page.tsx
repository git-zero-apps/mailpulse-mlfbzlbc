...
export default function EditSignupFormPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const updates: Record<string, unknown> = {
      ...
      fields_to_collect: formData.get("fields_to_collect"),
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          <label htmlFor="fields_to_collect" className="label">Fields To Collect</label>
          <input id="fields_to_collect" name="fields_to_collect" type="text" className="input" defaultValue={String(record.fields_to_collect ?? "")} />
        </div>
        <div>
        ...
        <div>
          <label htmlFor="form_slug" className="label">Form Slug</label>
          <input id="form_slug" name="form_slug" type="text" className="input" defaultValue={String(record.form_slug ?? "")} required />
        </div>
        <div>
