    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="fields_to_collect" name="fields_to_collect" type="text" className="input" placeholder="Enter fields to collect" />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="form_slug" name="form_slug" type="text" className="input" placeholder="Enter form slug" required />
        </div>
        <div>
