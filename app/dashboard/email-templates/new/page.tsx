    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        <div>
          ...
          <input id="workspace_id" name="workspace_id" type="text" className="input" placeholder="Enter workspace id" />
        </div>
        <div>
        ...
        <div className="flex items-center gap-3">
          <input id="is_global" name="is_global" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500" />
